...
- Given een aaneengesloten verblijf, then wordt de volledig bezette periode ertussen getoond als één doorlopende gekleurde balk (samengevoegde cel) met de gastnaam erin, i.p.v. een cel per dag; een eenzelfde-dag-turnover (vertrek + aankomst) toont beide voornamen in een eigen smalle cel op die dag.
