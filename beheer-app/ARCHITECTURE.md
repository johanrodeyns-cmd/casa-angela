...
Boekingen:      CRUD-form -> validateBooking() -> overlapsExistingBooking()-check (bookings + syncedBlocks,
                ...
                -> nog te bouwen: buildOccupancyMap() voor de Beschikbaarheidskalender (Epic 3, deelt dezelfde
                   kalendercomponent als de Prijskalender), JPG-export (2 varianten) via Canvas API
