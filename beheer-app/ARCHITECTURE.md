...
Boekingen:      CRUD-form -> validateBooking() -> overlapsExistingBooking()-check (bookings + syncedBlocks,
                ...
                -> Kopiëren voor contactpersoon: Van/Tot-periode -> bookingsInPeriod() -> formatBookingsListForContact()
                   -> navigator.clipboard.writeText() (platte tekst, geen JPG/Canvas, voor plakken in WhatsApp)
                -> nog te bouwen: klembord-export voor de tuinier (US-2.5, beperkte veldenset)
