...
Boekingen:      CRUD-form -> validateBooking() -> overlapsExistingBooking()-check (bookings + syncedBlocks,
                ...
                -> nog te bouwen: klembord-export (2 varianten, contactpersoon/tuinier) via
                   navigator.clipboard.writeText(), voor plakken in WhatsApp — geen JPG/Canvas
